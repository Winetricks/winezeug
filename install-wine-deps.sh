...
case $distro in
Ubuntu*7.10) apt-get install $ubuntu_gutsy_pkgs;;
Ubuntu*8.04) apt-get install $ubuntu_hardy_pkgs;;
Ubuntu*8.10) apt-get install $ubuntu_ibex_pkgs;;
